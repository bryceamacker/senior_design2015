 ...
 *  www.derekmolloy.ie
 *  Also modified by Bryce Amacker for the Logitech C310 by adding the -M mode for MJPG capture
 *
...
static void usage(FILE *fp, int argc, char **argv)
{
        fprintf(fp,
		 ...
		 "-M | --formatMJPG    Force format to 800x600 MJPG\n"
		 "-P | --formatJPG    Force format to 800x600 MJPG\n"
