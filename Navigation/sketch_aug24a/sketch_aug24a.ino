...
NUM_SENSORS, TIMEOUT, EMITTER_PIN);
	...
	void drive(wheels motor, int spd)
	{
		if (motor == left)
	...
	void driveRev(wheels motor, int spd)
	{
		if (motor == left)
	...
	void driveTank(wheels motor, int spd)
	{
		if (motor == left)
	...
	void driveTankRev(wheels motor, int spd)
	{
		if (motor == left)
	...
	void stopTankMotor(wheels motor)
	{
		if (motor == left)
			leftWheel.write(90);
		else if (motor == right)
